...
namespace Valve.VR
{
    public class LoadSceneActivator : MonoBehaviour
    {
        private static LoadSceneActivator _active = null;
        ...
        {
            var loader = new GameObject("loader").AddComponent<LoadSceneActivator>();
